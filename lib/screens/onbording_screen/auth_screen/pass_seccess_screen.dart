...
class PassSuccessScreen extends StatefulWidget {
  const PassSuccessScreen({super.key});

  @override
  State<PassSuccessScreen> createState() => _PassSuccessScreenState();
}

class _PassSuccessScreenState extends State<PassSuccessScreen> {
  @override
